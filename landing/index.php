    	...
    	<div class="row">
			...
			?>
				<div class="col-md-3 offset-1 cat_item">
					<a href="../overzicht/productpage.php?category=<?php echo $id;?>&pageNumber=0&sort=0&productAmount=30&filter=0&filterValue=0" style="color: black; text-decoration: none;">
